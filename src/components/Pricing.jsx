...
const Pricing = () => {
  return (
    <div name='pricing' className='w-full text-white my-24'>
      <div className='w-full h-[800px] bg-[#038C7F] absolute mix-blend-overlay'></div>
      ...
      <div className='max-w-[1240px] mx-auto py-12'>
        ...
        <div className='grid md:grid-cols-2'>
          ...
          <div className='bg-white text-slate-900 m-4 p-8 rounded-xl shadow-2xl relative'>
            <span className='uppercase px-3 py-1 bg-slate-100 text-[#027373] rounded-2xl text-sm'>Standard</span>
            <div>
            ...
            <div className='text-xl'>
                <p className='flex py-4'><CheckIcon className='w-8 mr-5 text-[#027373]'  />Lorem, ipsum dolor.</p>
                <p className='flex py-4'><CheckIcon className='w-8 mr-5 text-[#027373]'  />Lorem, ipsum dolor.</p>
                <p className='flex py-4'><CheckIcon className='w-8 mr-5 text-[#027373]'  />Lorem, ipsum dolor.</p>
                <p className='flex py-4'><CheckIcon className='w-8 mr-5 text-[#027373]'  />Lorem, ipsum dolor.</p>
                <p className='flex py-4'><CheckIcon className='w-8 mr-5 text-[#027373]'  />Lorem, ipsum dolor.</p>
          ...
          <div className='bg-white text-slate-900 m-4 p-8 rounded-xl shadow-2xl relative'>
            <span className='uppercase px-3 py-1 bg-slate-100 text-[#027373] rounded-2xl text-sm'>Premium</span>
            <div>
